...
def grades_crawler(login_url, username='1406100037', password='******', delay=5, user_agent=DEFAULT_AGENT, proxies=None,
    ...
    components = urllib.parse.urlsplit(url4)
    scheme = components.scheme
    netloc = components.netloc
    query = urllib.parse.quote(path.encode('gbk'), safe='?=&')
